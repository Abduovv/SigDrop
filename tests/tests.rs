...
use sig_drop::instructions::Initialize;
use sig_drop::states::{to_bytes, MyState};
use solana_sdk::rent::Rent;
use solana_sdk::sysvar::Sysvar;

pub const PROGRAM: Pubkey = pubkey!("8zASAJ7QL5t7S2oSTyAanSFFehAB2i3n4LiRHsZ6piuZ");
...
pub fn mollusk() -> Mollusk {
    let mollusk = Mollusk::new(&PROGRAM, "target/deploy/sig_drop");
    mollusk
}
